...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        public void setSecondLight(bool status)
        {
            if (status)
            {
                btnSecondLight.Text = "SecondLightOFF";
                secondLight = true;
            }
            else
            {
                btnSecondLight.Text = "SecondLightON";
                secondLight = false;
            }
        }
        ...
        private void btnSecondLight_Click(object sender, EventArgs e)
        {
            if (secondLight)
            {
                this.setSecondLight(false);
            }
            else
            {
                this.setSecondLight(true);
            }
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            GL.Light(LightName.Light1, LightParameter.Diffuse, light_1.getColors());
            GL.Light(LightName.Light1, LightParameter.Position, light_1.getPositions());
